...
| 4 — Polish + launch | [`plan-phase-4-launch.md`](plan-phase-4-launch.md) | T32–T47 (16 tasks; T41 trigger-gated deferred, not an exit blocker) | Admin smoke test, error monitoring, README, env checklist, launch checklist, security review, code review, doc audit, production deploy + post-launch ops + project content-model expansion + project media multi-image carousel + manual project/post drag-reorder + project writeup embedding + full public-site redesign (T46 — new light palette, single responsive tree, mobile fork deleted) | **Active — as of Session 52 (2026-08-04): T32–T39, T42, T43, T44, T45, T46 closed (T39 launched the site 2026-05-19/S27; T43 closed 2026-05-23/S40; T45 closed 2026-05-28/S44; T44 closed 2026-06-03/S47; T46 closed 2026-08-04/S51 — full redesign). **Updated Session 55 (2026-08-06):** the only open task is **T40** — 2 criteria (voice check on live copy, launch-checklist post-launch section), both builder-content-gated. **T47** (reliable e2e teardown) was added at Session 54 and closed at Session 55: teardown now sweeps the database with the service role, restores `sort_order`, and verifies against a fresh read rather than trusting the suite's own report. T41 deferred trigger-gated. The Playwright suite has now been run for the first time and is **15/15 green** (Session 54), which closed the long-standing "unrun suite" item and, in the process, found one real production bug (`post_id` missing from `PROJECT_COLUMNS` — the card's Writeup action was inert) and one new defect (the suite leaks live rows even when green → T47). The `/other` content half of the redesign gate closed at Session 53. **The one remaining builder-content gate is 6 sets of project screenshots**, which still has no task number — scope it via `@create-plan` before treating it as executable. Header-tick caveat resolved: T38, T39, T42, T43, T44, T45 were ticked by explicit builder decision at Session 53.** |
