...
interface TweakTextProps {
  ...
  placeholder?: string;
  onChange: (v: string) => void;
  // The bundle's Home pages pass a `multiline` prop on some calls. The bundle's
  // own TweakText control ignores it (renders a single-line input either way),
  // so we accept-and-ignore here to preserve verbatim call sites.
  multiline?: boolean;
}
